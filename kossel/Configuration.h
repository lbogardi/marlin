...
#define STRING_CONFIG_H_AUTHOR "(Laca & Maco, Kossel2016)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kossel2016"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 22.08
  #define  DEFAULT_Ki 1.36
  #define  DEFAULT_Kd 89.55
...
//#define PID_BED_DEBUG // Sends debug data to the serial port.
  ...
  #define  DEFAULT_bedKp 396.03
  #define  DEFAULT_bedKi 69.45
  #define  DEFAULT_bedKd 564.54
...
//  #define DELTA_SMOOTH_ROD_OFFSET 196.0 // mm
  #define DELTA_SMOOTH_ROD_OFFSET 188.0 // mm

  // Horizontal offset of the universal joints on the end effector.
  //#define DELTA_EFFECTOR_OFFSET 32.9 // mm
  ...
  // this can be increased a bit, but we need to find out, why Y axis goes up, when it reaches its limit
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 302.7 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define HOMING_FEEDRATE_XYZ (80*60)
#define HOMING_FEEDRATE_E 0
#define HOMING_FEEDRATE { HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_E }

// default settings
// delta speeds must be the same on xyz
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 96.61}  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define DEFAULT_RETRACT_ACCELERATION  8000    // E acceleration in mm/s^2 for retracts
